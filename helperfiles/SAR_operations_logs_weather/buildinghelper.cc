...
//         if (pos.z <= 0) {  // 🚨 Prevent z from going below 0
//           //  std::cout << "🚨 Warning: Node " << (*it)->GetId() << " has z=" << pos.z << " (underground!)" << std::endl;

//             pos.z = 2.0;  // Set a safe height

//             mobility->SetPosition(pos);

//           //  std::cout << "🚨 new z " << (*it)->GetId() << " has z=" << pos.z <<  std::endl;

//         }
//         else{

//           //  std::cout << "🚨 Warning: Node " << (*it)->GetId() << " has z=" << pos.z << " (aboveground!)" << std::endl;

//         }
//     }
//     Simulator::Schedule(Seconds(0.1), &EnsureNodesAboveGround);  // Re-run every 0.1s
// }
